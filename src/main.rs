...
use crypto::{check_openssl_available, generate_rsa_keypair};
                ...
                SecretAction::Generate {
                    ...
                    if flags.dry_run {
                        print_out(
                            flags,
                            &format!(
                                "(dry-run) Would generate {} key pair '{}' in env '{}'",
                                match key_type {
                                    KeyType::Pem => "RSA 2048-bit PEM",
                                },
                                key,
                                env
                            ),
                    ...
                    // Generate the key pair based on type
                    ...
                    if flags.json {
                        ...
                        print_out(
                            flags,
                            &format!(
                                "✓ Generated {} key pair '{}' in env '{}' (stored as '{}' and '{}')",
                                match key_type {
                                    KeyType::Pem => "RSA 2048-bit PEM",
                                },
                                key,
